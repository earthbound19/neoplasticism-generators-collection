...
# DEV NOTE
# Python 3 chokes on this (starting with an error about trying to use a float as an int).

# TO DO
# - Make it certain it will always fill in minimum 3 areas with red, blue and yellow
# - Paramaterize fill colors
# - Paramaterize fill colors from .hexplt format source color scheme text files
...
class Mondrian(object):
    ...
    def reset(self):
        ...
        for x in range(w):
            ...
            grid[h - 1][x] = 2
        # split
        split_count = random.randint(8, 24)
    ...
    def render(self, dc):
        colors = [
            ...
            # ALTERNATE: white is brown, three colors used are green, orange and violet; comment out the above color definitions if you uncomment the below:
            # wx.Colour(144, 60, 30),
            # wx.BLACK,
            # wx.BLACK,
            # wx.Colour(255, 144, 0),
